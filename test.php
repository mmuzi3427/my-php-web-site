...
if (isset($update->message)) {
    ...
    $start_text = "<tg-emoji emoji-id='5431407769846575322'>🤍</tg-emoji> Assalomu aleykum hurmatli {$f_name}! Xojiakbar blogs botga xush kelibsiz. \n\nMarhamat oʻzingizga kerakli boʻlimni tanlang! 👇";
...
if (isset($update->callback_query)) {
    ...
    // Aladhan API url
    $api_url = "https://api.aladhan.com/v1/timingsByCity/{$sana}?city=" . urlencode($region) . "&country=Uzbekistan&&method=14&school=1&tune=0,5,0,5,0,4,4,4,19";
